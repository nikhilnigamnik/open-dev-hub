...
import { getDev } from "@/lib/devs";
import Link from "next/link";
import React from "react";

const page = async ({ params: { devId } }) => {
  const data = await getDev(devId);

  return (
    <div className=" text-white p-4 max-w-5xl mx-auto flex flex-col gap-4">
